  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-16">
        <Link to="/auth" search={{ invite: undefined }} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground">
          ...
          <Accordion type="multiple" className="mt-3">
            ...
            <AccordionItem value="already">
              ...
              <AccordionContent className="text-sm text-muted-foreground">
                ...
                directly at the <Link to="/auth" search={{ invite: undefined }} className="underline">sign in page</Link>.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
